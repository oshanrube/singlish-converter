...
function convert() {
    ...
    var unicode = convertSinglishToUnicode(text);
    var fmabaya = convertUnicodeToFMAbaya(unicode);
    document.getElementById('unicode_textarea').value = unicode;
    document.getElementById('fmabaya_textarea').value = fmabaya;
}
var schemeVisible = 0;
